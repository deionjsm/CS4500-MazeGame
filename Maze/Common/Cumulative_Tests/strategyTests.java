...
public class strategyTests {
    ...
    public void testRiemannStrategy() {
        ...
        IStrategy strat = new RiemannStrategy();
        IMove moveReturned = strat.getDecision(info);
        //check that move is as expected
        assertFalse(moveReturned.getSkip());
        //assertFalse(moveReturned.doShiftAndInsert());
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getXCoordinate(), myGoal.getXCoordinate());
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getYCoordinate(), myGoal.getYCoordinate());
    ...
    public void testRiemannStrategyNOREACHGOAL() {
        ...
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getXCoordinate(), 6);
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getYCoordinate(), 6);
    ...
    public void testRiemannStrategy1Shift() {
        ...
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getXCoordinate(), 5);
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getYCoordinate(), 5);
        assertEquals(moveReturned.getRotation(), 0);
        assertEquals(moveReturned.getShiftDirection(), Direction.Right);
    ...
    public void testEUCLIDStrategy() {
        ...
        IMazePosition myHome = new MazePositionSimple(0,0);
        IFilteredInfo info = new SimpleFilteredInfo(board, spare, myPos, myGoal, myHome);
        IStrategy strat = new EuclidStrategy();
        IMove moveReturned = strat.getDecision(info);
        //check that move is as expected
        assertFalse(moveReturned.getSkip());
        //assertFalse(moveReturned.doShiftAndInsert());
    ...
    public void testEuclidStrategyNOREACHGOAL() {
        ...
        assertFalse(moveReturned.getSkip());
        //assertTrue(moveReturned.doShiftAndInsert());
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getXCoordinate(), 3);
        Assert.assertEquals(moveReturned.getMoveAvatarPos().getYCoordinate(), 6);
