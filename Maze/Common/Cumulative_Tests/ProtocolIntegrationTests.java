...
import Protocols.IPlayerProtocol;
import Protocols.IReferee;
import Protocols.PlayerUI;
import Protocols.RefProtocol;
...
public class ProtocolIntegrationTests {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IReferee ref = new RefProtocol(ipp, testableState);
