...
public class stateTests {
    ...
    public void testShiftAndInsert() {
        ...
        Assert.assertEquals(player1.getCurrentColumn(),1);
        Assert.assertEquals(player1.getCurrentRow(),0);
        assertTrue(s.shiftAndInsert(0,BoardOpt.Row, Direction.Left));
        Assert.assertEquals(0,player1.getCurrentColumn());
        Assert.assertEquals(0,player1.getCurrentRow());
        //SWITCH LEFT
        assertTrue(s.shiftAndInsert(0,BoardOpt.Row,Direction.Left));
        Assert.assertEquals(player1.getCurrentColumn(),6);
        Assert.assertEquals(player1.getCurrentRow(),0);
        assertTrue(s.shiftAndInsert(0,BoardOpt.Row,Direction.Left));
        Assert.assertEquals(player1.getCurrentColumn(),5);
        Assert.assertEquals(player1.getCurrentRow(),0);
        assertTrue(s.shiftAndInsert(0,BoardOpt.Row,Direction.Right));
        Assert.assertEquals(player1.getCurrentColumn(),6);
        Assert.assertEquals(player1.getCurrentRow(),0);
        //SWITCH SIDES RIGHT
        assertTrue(s.shiftAndInsert(0,BoardOpt.Row,Direction.Right));
        Assert.assertEquals(player1.getCurrentColumn(),0);
        Assert.assertEquals(player1.getCurrentRow(),0);

        assertTrue(s.shiftAndInsert(0,BoardOpt.Col,Direction.Down));
        Assert.assertEquals(player1.getCurrentColumn(),0);
        Assert.assertEquals(player1.getCurrentRow(),1);
        ...
        assertTrue(s.shiftAndInsert(0,BoardOpt.Col,Direction.Up));
        Assert.assertEquals(player1.getCurrentColumn(),0);
        Assert.assertEquals(player1.getCurrentRow(),6);
        //switch DOWN
        assertTrue(s.shiftAndInsert(0,BoardOpt.Col,Direction.Down));
        Assert.assertEquals(player1.getCurrentColumn(),0);
        Assert.assertEquals(player1.getCurrentRow(),0);
